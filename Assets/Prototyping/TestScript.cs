...
public class TestScript : MonoBehaviour
{
    ...
    private GameObject squareObject; // = new GameObject("Square");
    ...
    void Start()
    {
        ...
        squareObject.transform.position = new Vector3(0, 0, 0); // Initial position of the square, offset to the right
    ...
    void MoveSquare()
    {
        squareObject.transform.Translate(Vector3.right * moveSpeed * Time.deltaTime); // Moves the object in the x-direction
        // NOTE: left is right???????
    ...
    System.Collections.IEnumerator RotateAndStop()
    {
        ...
        Vector3 startRotation = squareObject.transform.localEulerAngles;
        ...
        {
            t += Time.deltaTime;
            squareObject.transform.localEulerAngles = Vector3.Lerp(startRotation, endRotation, t);

            yield return null;
        }
        squareObject.transform.localEulerAngles = startRotation;
        isRotating = false;
    }
}
